...
path = ""
# 这里修改了路径
checkpoint = "./checkpoint_{}_{}_{}_{}_{}_10000.pt".format(embedding_model, str(embedding_size), str(num_layers), str(hidden_size), partition)
...
def savecheckpoint(state, is_best):
    ...
    # 这里修改了路径
    if is_best:
        shutil.copyfile(checkpoint, os.path.join(path, 'best_model_{}_{}_{}_{}_{}_100000.pt'.format(embedding_model, str(embedding_size), str(num_layers), str(hidden_size), partition)))
